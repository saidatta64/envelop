        ...
        <div className="write-container" style={{
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{
                            ...
                            <button type="submit" className="btn-primary" disabled={loading} style={{
                                ...
                                alignItems: 'center',
                                gap: '0.75rem',
                                backgroundColor: isSidebarOpen ? 'var(--foreground)' : (bgColor === '#ffffff' ? '#000' : textColor),
                                color: isSidebarOpen ? 'var(--background)' : (bgColor === '#ffffff' ? '#fff' : bgColor),
                            }}>
                                {loading ? 'Publishing...' : (
                                    <>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <span className="caps" style={{ fontSize: '0.65rem', opacity: 0.5 }}>Personalize your space</span>
                </div>
